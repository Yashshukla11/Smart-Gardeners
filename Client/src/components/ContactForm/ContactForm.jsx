  ...
  return (
    <>
      <div class="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
        ...
        <div class="">
          <div>
            <span class="uppercase text-2xl text-gray-600 font-bold">
              Full Name
            </span>
            <input
          ...
          <div class="mt-8">
            <button class="uppercase text-2xl font-bold tracking-wide bg-indigo-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
              Send Message
            </button>
          </div>
        </div>
