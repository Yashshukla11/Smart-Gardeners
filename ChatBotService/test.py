...
# data_directory = os.path.join(current_path)
# documents = load_docs(data_directory)
# print(len(documents))
...
response=get_gemini_response("who are you")
# Add user query and response to session state chat history
print(response)
chat.history.append(("You", "who are you"))
for chunk in response:
    print(chunk.text)
    chat.history.append(("Bot", chunk.text))
